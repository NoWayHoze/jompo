...
(def class11 (core/new-class :x 10 :y 11 :z 100))
(def class12 (core/new-class :a 20 :b 21 :c 200))
(def class13 (core/new-class :d 10 :e 11 :f 100))
(def class14 (core/new-class :k 20 :l 21 :m 200))

(class14 :members)

(def class15 (core/combine class11 class12 class13 class14))
...
(def array-class (core/new-class :myarr []))
(def my-arr-c (array-class :myarr [1 2 3]))
