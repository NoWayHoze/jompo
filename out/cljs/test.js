...
var args6945 = [];
var len__5527__auto___6949 = arguments.length;
var i__5528__auto___6950 = (0);
while(true){
if((i__5528__auto___6950 < len__5527__auto___6949)){
args6945.push((arguments[i__5528__auto___6950]));

var G__6951 = (i__5528__auto___6950 + (1));
i__5528__auto___6950 = G__6951;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args6945.length)].join('')));
...
var G__6948 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
var G__6948__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__6948,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__6948);
return G__6948__$1;
});
...
var or__4469__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__5527__auto___6956 = arguments.length;
var i__5528__auto___6957 = (0);
while(true){
if((i__5528__auto___6957 < len__5527__auto___6956)){
args__5534__auto__.push((arguments[i__5528__auto___6957]));

var G__6958 = (i__5528__auto___6957 + (1));
i__5528__auto___6957 = G__6958;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5535__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq6953){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__6954,G__6955,seq6953__$2);
});
...
var file = cljs.core.get.call(null,map__6962__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__6962__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__6962__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__6962,map__6962__$1,file,line,column){
return (function (p1__6959_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__6959_SHARP_));
});})(map__6962,map__6962__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__5382__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__5382__auto__,prefer_table__5383__auto__,method_cache__5384__auto__,cached_hierarchy__5385__auto__,hierarchy__5386__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__4469__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__4469__auto__)){
return or__4469__auto__;
} else {
...
var temp__4425__auto___6964 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___6964)){
var message_6965 = temp__4425__auto___6964;
cljs.core.println.call(null,message_6965);
} else {
}
...
var temp__4425__auto___6966 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___6966)){
var message_6967 = temp__4425__auto___6966;
cljs.core.println.call(null,message_6967);
} else {
}
...
var temp__4423__auto__ = (function (){var and__4457__auto__ = typeof exception.stack === 'string';
if(and__4457__auto__){
var G__6973 = exception.stack;
var G__6973__$1 = (((G__6973 == null))?null:clojure.string.split_lines.call(null,G__6973));
var G__6973__$2 = (((G__6973__$1 == null))?null:cljs.core.get.call(null,G__6973__$1,depth));
var G__6973__$3 = (((G__6973__$2 == null))?null:clojure.string.trim.call(null,G__6973__$2));
return G__6973__$3;
} else {
...
var vec__6974 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__6974,(0),null);
var column = cljs.core.nth.call(null,vec__6974,(1),null);
var vec__6975 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__6975,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__6975,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__6975,(2),null);
...
var m__$1 = (function (){var G__6977 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__6977) {
case "fail":
...
var G__6983 = (function (){var G__6982 = cljs.core.rest.call(null,fns);
var G__6982__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__6982):G__6982);
return G__6982__$1;
})();
fns = G__6983;
continue;
...
var G__6985 = fns;
var G__6985__$1 = (((G__6985 == null))?null:cljs.core.vary_meta.call(null,G__6985,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__6985__$1;
});
...
}catch (e6988){var e = e6988;
var G__6989 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__6989) {
...
var vec__6992 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__6992,(0),null);
var types = vec__6992;
...
return cljs.core.map.call(null,(function (p__7000){
var vec__7001 = p__7000;
var ns = cljs.core.nth.call(null,vec__7001,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__7001,(1),null);
return ((function (vec__7001,ns,vars__$1){
return (function (){
...
var G__7002 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__7002) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__7002,env,once_fixtures,each_fixtures,vec__7001,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__7002,env,once_fixtures,each_fixtures,vec__7001,ns,vars__$1){
return (function (){
var seq__7003 = cljs.core.seq.call(null,vars__$1);
var chunk__7004 = null;
var count__7005 = (0);
var i__7006 = (0);
while(true){
if((i__7006 < count__7005)){
var v = cljs.core._nth.call(null,chunk__7004,i__7006);
var temp__4425__auto___7008 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___7008)){
var t_7009 = temp__4425__auto___7008;
each_fixture_fn.call(null,((function (seq__7003,chunk__7004,count__7005,i__7006,t_7009,temp__4425__auto___7008,v,each_fixture_fn,G__7002,env,once_fixtures,each_fixtures,vec__7001,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_7009)));
});})(seq__7003,chunk__7004,count__7005,i__7006,t_7009,temp__4425__auto___7008,v,each_fixture_fn,G__7002,env,once_fixtures,each_fixtures,vec__7001,ns,vars__$1))
);
} else {
}

var G__7010 = seq__7003;
var G__7011 = chunk__7004;
var G__7012 = count__7005;
var G__7013 = (i__7006 + (1));
seq__7003 = G__7010;
chunk__7004 = G__7011;
count__7005 = G__7012;
i__7006 = G__7013;
...
var temp__4425__auto__ = cljs.core.seq.call(null,seq__7003);
if(temp__4425__auto__){
var seq__7003__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__7003__$1)){
var c__5272__auto__ = cljs.core.chunk_first.call(null,seq__7003__$1);
var G__7014 = cljs.core.chunk_rest.call(null,seq__7003__$1);
var G__7015 = c__5272__auto__;
var G__7016 = cljs.core.count.call(null,c__5272__auto__);
var G__7017 = (0);
seq__7003 = G__7014;
chunk__7004 = G__7015;
count__7005 = G__7016;
...
var v = cljs.core.first.call(null,seq__7003__$1);
var temp__4425__auto___7018__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___7018__$1)){
var t_7019 = temp__4425__auto___7018__$1;
each_fixture_fn.call(null,((function (seq__7003,chunk__7004,count__7005,i__7006,t_7019,temp__4425__auto___7018__$1,v,seq__7003__$1,temp__4425__auto__,each_fixture_fn,G__7002,env,once_fixtures,each_fixtures,vec__7001,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_7019)));
});})(seq__7003,chunk__7004,count__7005,i__7006,t_7019,temp__4425__auto___7018__$1,v,seq__7003__$1,temp__4425__auto__,each_fixture_fn,G__7002,env,once_fixtures,each_fixtures,vec__7001,ns,vars__$1))
);
} else {
}

var G__7020 = cljs.core.next.call(null,seq__7003__$1);
var G__7021 = null;
var G__7022 = (0);
var G__7023 = (0);
seq__7003 = G__7020;
...
});})(each_fixture_fn,G__7002,env,once_fixtures,each_fixtures,vec__7001,ns,vars__$1))
);
});})(each_fixture_fn,G__7002,env,once_fixtures,each_fixtures,vec__7001,ns,vars__$1))
], null);
